        ...
        <header class="sticky-top">
            <nav class="navbar navbar-light bg-light ">
                ...
                <div class="left-side d-flex align-items-center">
                    <a class="text-center publish-link mx-2" data-bs-toggle="modal" data-bs-target="#publishModal">
                        <i class="bi bi-plus-square"></i>
                    </a>
                    <button class="button-profile p-3" data-toggle="collapse" data-target="#profil-Dropdown">
                        <img src="<?php if (isset($_SESSION['user']['picture']) && $_SESSION['user']['picture'] !== '') echo 'uploads/' . $_SESSION['user']['picture'];
                                    else echo 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png'; ?>" alt="The Eye of Storm">
